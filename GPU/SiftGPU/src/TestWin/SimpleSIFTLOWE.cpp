...
int main()
{
    ...
    //char * argv[] = {"-fo", "-1",  "-v", "1"};//
    char * argv[] = {"-fo", "-1",  "-v", "1","-t","0.03","-loweo","-cuda","0","-maxd","1024"};
    ...
    sift->SaveSIFT("../data/lowe/sample.sift.1");
    //Test 2
    ...
    if(sift->RunSIFT("../data/sample.ppm"))
    {
        ...
        sift->SaveSIFT("../data/lowe/sample.sift.2");
    }
    //Test 3
    std::cout << "Test-3"<<std::endl;
    sift->RunSIFT(mykeys.size(), &mykeys[0]);
    sift->RunSIFT(num2, &keys2[0], 1);
    sift->SaveSIFT("../data/lowe/sample.sift.3");
    //Test 3A
    std::cout << "Test-3A"<<std::endl;
    (sift->RunSIFT("../data/sample.ppm"));
    sift->RunSIFT(mykeys.size(), &mykeys[0]);
    sift->RunSIFT(num2, &keys2[0], 1);
    sift->SaveSIFT("../data/lowe/sample.sift.3A");
    //Test 4
    std::cout << "Test-4"<<std::endl;
    sift->RunSIFT(num2, &keys2[0], 0);
    sift->SaveSIFT("../data/lowe/sample.sift.4");
    //Test 4A
    std::cout << "Test-4A"<<std::endl;
    (sift->RunSIFT("../data/sample.ppm"));
    sift->RunSIFT(num2, &keys2[0], 0);
    sift->SaveSIFT("../data/lowe/sample.sift.4A");
    //Test 5
    ...
    sift->RunSIFT("../data/sample.ppm");
    sift->SaveSIFT("../data/lowe/sample.sift.5");
    //Test 6
    std::cout << "Test-6"<<std::endl;
    sift->RunSIFT("../data/sample.ppm");
    sift->RunSIFT(100, mykey, 0);
    sift->SaveSIFT("../data/lowe/sample.sift.6");
