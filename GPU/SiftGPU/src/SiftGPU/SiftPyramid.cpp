...
void SiftPyramid::RunSIFT(GLTexInput*input)
{
	...
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-1"<<std::endl; 
	if(_existing_keypoints & SIFT_SKIP_FILTERING)
	{
		
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-1.1"<<std::endl; 
	}else
	{
		
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-1.2"<<std::endl; 
		GlobalUtil::StartTimer("Build    Pyramid");
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-1.3"<<std::endl; 
		BuildPyramid(input);
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-1.4"<<std::endl; 
		GlobalUtil::StopTimer();
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-1.5"<<std::endl; 
		_timing[0] = GetElapsedTime();
	}

	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-2"<<std::endl; 
	...
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-3"<<std::endl; 
	...
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-4"<<std::endl; 
	PrepareBuffer();
	...
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-5"<<std::endl; 
    ...
    //clean up
    CleanUpAfterSIFT();
	//std::cout<<"Estas la entrada a SiftPyramid::RunSIFT-Fin"<<std::endl; 
}
